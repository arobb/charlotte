...
class StatsDaemon(Daemon):
    def run(self):
        ...
        bridge_rtlatency_statsfile = dir + "/put_att_bridge_latency.sh"
        
        while True:
            try:
                throughput_output = subprocess.check_output([bridge_rtlatency_statsfile, "eth0"])
...
if __name__ == "__main__":
    ...
    daemon = StatsDaemon('/tmp/statsdaemon_att_bridge.pid', stdin='/dev/null', stdout='/dev/stdout', stderr='/dev/stderr')
