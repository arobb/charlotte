...
class StatsDaemon(Daemon):
    def run(self):
        ...
        att_rtlatency_statsfile = dir + "/put_att_gateway_latency.sh"
        
        while True:
            try:
                throughput_output = subprocess.check_output([att_rtlatency_statsfile, "eth0"])
...
if __name__ == "__main__":
    ...
    daemon = StatsDaemon('/tmp/statsdaemon_att.pid', stdin='/dev/null', stdout='/dev/stdout', stderr='/dev/stderr')
