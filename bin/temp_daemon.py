...
class TempDaemon(Daemon):
    def run(self):
        ...
        temp_statsfile = "./" + dir + "/put_temperature.sh"
        ...
        while True:
            ...
            try:
                temperature_output = subprocess.check_output([temp_statsfile])
...
if __name__ == "__main__":
    ...
    daemon = TempDaemon('/tmp/tempdaemon.pid', stdin='/dev/null', stdout='/dev/stdout', stderr='/dev/stderr')
